pipeline {
    ...
    parameters {
        ...
        string(name: 'Ec2Subnet', description: 'Subnet to associate to the Instance.')
        string(name: 'Ec2TemplateUri', description: 'Link to EC2 template')
